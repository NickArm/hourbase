...
## [9.0.8] - 2026-02-08
### Added
- Added authenticated API GET endpoints for core entities (clients, projects, tasks, time entries, invoices, tags)
- Added API auth endpoints (login, logout, me) using Sanctum tokens

### Fixed
- Hardened ownership checks to prevent 403 errors from ID type mismatches
- Added missing DB facade import in TagController
